...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/SetJumperHTML_atlas_.png?1471371146062", id:"SetJumperHTML_atlas_"}
	]
};
...
lib.ssMetadata = [
		{name:"SetJumperHTML_atlas_", frames: [[0,302,400,300],[0,0,400,300],[0,604,400,300]]}
];
...
(lib.SetJumper = function(mode,startPosition,loop) {
	...
	this.shape.graphics.f().s("#FF0000").ss(3.4,1,1).p("ADCAAQAABQg4A5Qg6A6hQAAQhQAAg5g6Qg5g5AAhQQAAhQA5g4QA5g6BQAAQBQAAA6A6QA4A4AABQg");
	this.shape.setTransform(28.1,103.5);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f().s("#FF0000").ss(4.2,1,1).p("AmnAAQAAivB8h8QB8h8CvAAQCwAAB8B8QB8B8AACvQAACwh8B8Qh8B8iwAAQivAAh8h8Qh8h8AAiwg");
	this.shape_1.setTransform(55.7,112);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f().s("#FF0000").ss(4.9,1,1).p("ApzAAQAAkEC4i3QC3i4EEAAQEFAAC4C4QC4C3AAEEQAAEFi4C4Qi4C4kFAAQkEAAi3i4Qi4i4AAkFg");
	this.shape_2.setTransform(80.4,119.7);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f().s("#FF0000").ss(5.5,1,1).p("AsoAAQAAlPDtjtQDsjsFPAAQFQAADtDsQDsDtAAFPQAAFQjsDtQjtDslQAAQlPAAjsjsQjtjtAAlQg");
	this.shape_3.setTransform(102.1,126.5);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f().s("#FF0000").ss(6,1,1).p("AvFAAQAAmQEbkaQEakbGQAAQGRAAEbEbQEaEaAAGQQAAGRkaEbQkbEamRAAQmQAAkakaQkbkbAAmRg");
	this.shape_4.setTransform(121,132.3);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f().s("#FF0000").ss(6.5,1,1).p("AxKAAQAAnHFClBQFBlBHHAAQHIAAFCFBQFBFBAAHHQAAHIlBFCQlCFBnIAAQnHAAlBlBQlClCAAnIg");
	this.shape_5.setTransform(137,137.3);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f().s("#FF0000").ss(6.9,1,1).p("Ay2AAQAAn0FhlhQFglhH1AAQH1AAFhFhQFhFhAAH0QAAH1lhFhQlhFhn1AAQn1AAlglhQlhlhAAn1g");
	this.shape_6.setTransform(150.1,141.4);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.f().s("#FF0000").ss(7.2,1,1).p("A0LAAQAAoXF6l6QF6l5IXAAQIYAAF6F5QF6F6AAIXQAAIYl6F6Ql6F5oYAAQoXAAl6l5Ql6l6AAoYg");
	this.shape_7.setTransform(160.3,144.5);

	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.f().s("#FF0000").ss(7.4,1,1).p("A1HAAQAAowGMmLQGLmMIwAAQIxAAGMGMQGLGLAAIwQAAIxmLGMQmMGLoxAAQowAAmLmLQmMmMAAoxg");
	this.shape_8.setTransform(167.5,146.8);

	this.shape_9 = new cjs.Shape();
	this.shape_9.graphics.f().s("#FF0000").ss(7.5,1,1).p("A1rAAQAAo/GWmWQGWmWI/AAQJAAAGWGWQGWGWAAI/QAAJAmWGWQmWGWpAAAQo/AAmWmWQmWmWAApAg");
	this.shape_9.setTransform(171.9,148.1);

	this.shape_10 = new cjs.Shape();
	this.shape_10.graphics.f().s("#FF0000").ss(7.5,1,1).p("AV4AAQAAJFmZGaQmaGZpFAAQpEAAmZmZQmamaAApFQAApEGamZQGZmaJEAAQJFAAGaGaQGZGZAAJEg");
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(34).to({_off:false},0).wait(17));
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(10).to({_off:false},0).to({scaleX:1,scaleY:1,x:189,y:150,alpha:1},10,cjs.Ease.get(1)).to({_off:true},14).wait(17));

	// Calque 7
	this.shape_12 = new cjs.Shape();
	this.shape_12.graphics.f().s("#FF0000").ss(3.4,1,1).p("ADCAAQAABQg4A5Qg6A6hQAAQhQAAg5g6Qg5g5AAhQQAAhQA5g4QA5g6BQAAQBQAAA6A6QA4A4AABQg");
	this.shape_12.setTransform(28.1,103.5);
	this.shape_12._off = true;

	this.timeline.addTween(cjs.Tween.get(this.shape_12).wait(10).to({_off:false},0).wait(41));
